            ...
            <form action="SAlumnos" method='post' id='formulario'>
                ...
                <div class="row">
                    ...
                    <div class='col-4'>
                        ...
                        <input type='text' class='controls' name='tfApellidoPaterno' value = "<%=alumno.getApellidoPaterno()%>">
                    </div>
                    <div class='col-4'>
                        <label for='lblApellidoMaterno'>APELLIDO MATERNO</label>
                        <input type='text' class='controls' name='tfApellidoMaterno' value = "<%=alumno.getApellidoMaterno()%>"> 
                    </div>
                </div>
                ...
                <div class="row">
                    <div class='col-4'>
                        ...
                        <input type='number' class='controls' name='tfDdi' value = "<%=alumno.getDdi()%>"> 
                    </div>
                    <div class='col-4'>
                        <label for='lblDwi'>DWI</label>
                        <input type='number' class='controls' name='tfDwi' value = "<%=alumno.getDwi()%>">
                    </div>
                    <div class='col-4'>
                        <label for='lblEcbd'>ECBD</label>
                        <input type='number' class='controls' name='tfEcbd' value = "<%=alumno.getEcbd()%>">
                    </div>
